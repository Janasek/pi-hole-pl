...
<div class="row">
    <div class="col-lg-3 col-sm-6">
        ...
        <div class="small-box bg-green no-user-select" id="total_queries" title="only A + AAAA queries">
            <div class="inner">
                <p>Całkowita liczba zapytań (<span id="unique_clients">-</span> klientów)</p>
    ...
    <div class="col-lg-3 col-sm-6">
        ...
        <div class="small-box bg-red no-user-select" title="<?php echo gravity_last_update(); ?>">
            <div class="inner">
                <p>Domeny na liście zablokowanych</p>
...
<div class="row">
    ...
    <div class="box" id="queries-over-time">
        <div class="box-header with-border">
          <h3 class="box-title">Całkowita liczba zapytań w ci&#x0105;gu ostatnich <?php echo getinterval(); ?> godzin</h3>
        </div>
        <div class="box-body">
          <div class="chart">
...
<div class="row">
    ...
    <div class="box" id="clients">
        <div class="box-header with-border">
          <h3 class="box-title">Aktywność klienta w ostatnich <?php echo getinterval(); ?> godzinach</h3>
        </div>
        <div class="box-body">
          <div class="chart">
...
<div class="row">
    ...
    <div class="box" id="query-types-pie">
        <div class="box-header with-border">
          <h3 class="box-title">Typ zapytań</h3>
        </div>
        <div class="box-body">
    ...
    <div class="box" id="forward-destinations-pie">
        <div class="box-header with-border">
          <h3 class="box-title">Odpowiedzi na zapytania</h3>
        </div>
        <div class="box-body">
          <div class="pull-left" style="width:50%">
...
<div class="row">
    <div class="<?php echo $tablelayout; ?>">
      <div class="box" id="domain-frequency">
        <div class="box-header with-border">
          <h3 class="box-title">Top Dozwolone domeny</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
    ...
    <div class="<?php echo $tablelayout; ?>">
      <div class="box" id="ad-frequency">
        <div class="box-header with-border">
          <h3 class="box-title">Top Zablokowanych domen</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <div class="table-responsive">
...
<div class="row">
    ...
    <div class="<?php echo $tablelayout; ?>">
      <div class="box" id="client-frequency">
        <div class="box-header with-border">
          <h3 class="box-title">Top Klienci (łącznie)</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <div class="table-responsive">
    ...
    <div class="<?php echo $tablelayout; ?>">
      <div class="box" id="client-frequency-blocked">
        <div class="box-header with-border">
          <h3 class="box-title">Top klienci (tylko zablokowani)</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            <div class="table-responsive">
