        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Niestandardowy limit czasu wyłączenia</h4>
                </div>
    ...
    <footer class="main-footer">
        <div class="row row-centered text-center">
            <div class="col-xs-12 col-sm-6">
                <strong><a href="https://pi-hole.net/donate/" rel="noopener" target="_blank"><i class="fa fa-heart text-red"></i> Wesprzyj nas</a></strong> jeśli uznasz Pi-Hole za przydatne.
            </div>
        </div>
        ...
        <div class="row row-centered text-center version-info">
            <div class="col-xs-12 col-sm-8 col-md-6">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><strong>Interfejs sieciowy</strong> <?php echo $webVersionStr; ?></li>
                ...
                <ul class="list-inline">
                    <li>
                        ...
                        <?php if ($core_update) { ?> &middot; <a class="lookatme" href="<?php echo $coreReleasesUrl . "/latest"; ?>" rel="noopener" target="_blank">Dostępna aktualizacja!</a><?php } ?>
                    </li>
                    <li>
                        <strong>Interfejs sieciowy</strong>
                        <a href="<?php echo $webReleasesUrl . "/" . $web_current; ?>" rel="noopener" target="_blank"><?php echo $web_current; ?></a>
                        <?php if ($web_update) { ?> &middot; <a class="lookatme" href="<?php echo $webReleasesUrl . "/latest"; ?>" rel="noopener" target="_blank">Dostępna aktualizacja!</a><?php } ?>
                    </li>
                    <li>
                        <strong>FTL</strong>
                        <a href="<?php echo $ftlReleasesUrl . "/" . $FTL_current; ?>" rel="noopener" target="_blank"><?php echo $FTL_current; ?></a>
                        <?php if ($FTL_update) { ?> &middot; <a class="lookatme" href="<?php echo $ftlReleasesUrl . "/latest"; ?>" rel="noopener" target="_blank">Dostępna aktualizacja!</a><?php } ?>
                    </li>
                </ul>
                <?php } ?>
            </div>
