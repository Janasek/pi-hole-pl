...
<noscript>
    ...
    <div>
        ...
        <div class="js-warn" id="js-warn-exit"><h1>JavaScript jest wyłączony</h1><p>Witryna wymaga obsługi JavaScript.</p>
            <p>Aby dowiedzieć się, jak włączyć JavaScript, kliknij <a href="https://www.enable-javascript.com/" rel="noopener" target="_blank">tutaj</a></p><label for="js-hide">Zamknij</label>
        </div>
    </div>
    <!-- /JS Warning -->
</noscript>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li<?php echo !$hostname ? ' class="hidden"' : "" ?>>
                        <p class="navbar-text">
                            <span class="hidden-xs hidden-sm">Nazwa hosta:</span>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    ...
                                    <small>Zaprojektowany dla Raspberry Pi</small>
                                </p>
                            </li>
                            <!-- Menu Body -->
                            <li class="user-body">
                                <div class="row">
                                    ...
                                    <div class="col-xs-4 text-center">
                                        <a class="btn-link" href="https://github.com/pi-hole/pi-hole/releases" rel="noopener" target="_blank">Aktualizacja</a>
                                    </div>
                                    <div id="sessiontimer" class="col-xs-12 text-center">
                                        <strong>Sesja jest ważna przez <span id="sessiontimercounter"><?php if($auth && strlen($pwhash) > 0){echo $maxlifetime;}else{echo "0";} ?></span></strong>
                                    </div>
                                </div>
                            </li>
                            <!-- Menu Footer -->
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                <li class="header text-uppercase">Ustawienia</li>
                <!-- Home Page -->
                <li<?php if($scriptname === "index.php"){ ?> class="active"<?php } ?>>
                    <a href="index.php">
                        <i class="fa fa-home"></i> <span>Panel Ustawień</span>
                    </a>
                </li>
                <?php if($auth){ ?>
                <!-- Query Log -->
                ...
                <li class="treeview<?php if (in_array($scriptname, array("groups.php", "groups-adlists.php", "groups-clients.php", "groups-domains.php"))){ ?> active<?php } ?>">
                  <a href="#">
                    <i class="fa fa-users-cog"></i> <span>Zarządzanie grupami</span>
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                ...
                <li id="pihole-disable" class="treeview"<?php if ($pistatus == "0") { ?> hidden<?php } ?>>
                  <a href="#">
                    ...
                    <i class="fa fa-stop"></i> <span>Wyłącz&nbsp;&nbsp;&nbsp;<span id="flip-status-disable"></span></span>
                  </a>
                  <ul class="treeview-menu">
                    <li>
                        <a href="#" id="pihole-disable-indefinitely">
                            <i class="fa fa-stop"></i> Na czas nieokreślony
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-10s">
                            <i class="fa fa-clock"></i> Na 10 sekund
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-30s">
                            <i class="fa fa-clock"></i> Na 30 sekund
                        </a>
                    </li>
                    <li>
                        <a href="#" id="pihole-disable-5m">
                            <i class="fa fas fa-clock"></i> Na 5 minut
                        </a>
                    </li>
                    <li>
                      <a href="#" id="pihole-disable-cst" data-toggle="modal" data-target="#customDisableModal">
                            <i class="fa fa-clock"></i> <span>Czas niestandardowy</span>
                      </a>
                    </li>
                  </ul>
                ...
                <li class="treeview<?php if (in_array($scriptname, array("messages.php", "gravity.php", "queryads.php", "auditlog.php", "taillog.php", "taillog-FTL.php", "debug.php", "network.php"))){ ?> active<?php } ?>">
                  <a href="#">
                    <i class="fa fa-folder"></i> <span>Narzędzia</span>
                    <span class="pull-right-container">
                      <i class="fa fa-angle-left pull-right"></i>
                    </span>
                  </a>
                  <ul class="treeview-menu">
                    ...
                    <li<?php if($scriptname === "messages.php"){ ?> class="active"<?php } ?>>
                        <a href="messages.php">
                            <i class="fa fa-stethoscope"></i> Diagnostyka Pi-hole
                        </a>
                    </li>
                    <!-- Run gravity.sh -->
                    <li<?php if($scriptname === "gravity.php"){ ?> class="active"<?php } ?>>
                        <a href="gravity.php">
                            <i class="fa fa-arrow-circle-down"></i> Zaktualizuj Gravity
                        </a>
                    </li>
                    <!-- Query Lists -->
                    <li<?php if($scriptname === "queryads.php"){ ?> class="active"<?php } ?>>
                        <a href="queryads.php">
                            <i class="fa fa-search"></i> Listy zapytań
                        </a>
                    </li>
                    <!-- Audit log -->
                    <li<?php if($scriptname === "auditlog.php"){ ?> class="active"<?php } ?>>
                        <a href="auditlog.php">
                            <i class="fa fa-balance-scale"></i> Dziennik kontroli
                        </a>
                    </li>
                    <!-- Tail pihole.log -->
                    ...
                    <li<?php if($scriptname === "debug.php"){ ?> class="active"<?php } ?>>
                        <a href="debug.php">
                            <i class="fa fa-ambulance"></i> Wygeneruj dziennik debugowania
                        </a>
                    </li>
                    <!-- Network -->
                    <li<?php if($scriptname === "network.php"){ ?> class="active"<?php } ?>>
                        <a href="network.php">
                            <i class="fa fa-network-wired"></i> Sieć
                        </a>
                    </li>
                  </ul>
                </li>
                ...
                <li>
                    <a href="?logout">
                        <i class="fa fa-user-times"></i> <span>Wyloguj</span>
                    </a>
                </li>
                <?php } ?>
                <?php } ?>
                ...
                <li<?php if($scriptname === "login"){ ?> class="active"<?php } ?>>
                    <a href="index.php?login">
                        <i class="fa fa-user"></i> <span>Zaloguj</span>
                    </a>
                </li>
                <?php } ?>
                <!-- Donate -->
                <li>
                    <a href="https://pi-hole.net/donate/" rel="noopener" target="_blank">
                        <i class="fab fa-paypal"></i> <span>Wsparcie</span>
                    </a>
                </li>
                 <!-- Docs -->
                 <li>
                    <a href="https://docs.pi-hole.net/" rel="noopener" target="_blank">
                        <i class="fa fa-question-circle"></i> <span>Dokumentacja</span>
                    </a>
                </li>
            </ul>
        </section>
